...
Update
----
* REBEL added fp8 scaling support for my model, i also added a bypass of flash attn. not tested because i OOM on my 3070 (8gb vram). just doing my part to the community. https://huggingface.co/realrebelai/DaVinci_MagiHuman_fp8_merges/tree/main
