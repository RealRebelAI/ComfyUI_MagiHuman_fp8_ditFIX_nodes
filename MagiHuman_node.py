...
from .MagiHuman_unload_node import MagiHuman_UnloadDiT
...
class MagiHuman_Rebel_Model(io.ComfyNode):
    @classmethod
    def define_schema(cls):
        return io.Schema(
            node_id="MagiHuman_Rebel_Model",
            display_name="MagiHuman_Rebel_Model",
            category="MagiHuman_Rebel",
            inputs=[
...
class MagiHuman_Rebel_VAE(io.ComfyNode):
    @classmethod
    def define_schema(cls):
        return io.Schema(
            node_id="MagiHuman_Rebel_VAE",
            display_name="MagiHuman_Rebel_VAE",
            category="MagiHuman_Rebel",
            inputs=[
...
class MagiHuman_Rebel_Clip(io.ComfyNode):
    @classmethod
    def define_schema(cls):
        return io.Schema(
            node_id="MagiHuman_Rebel_Clip",
            display_name="MagiHuman_Rebel_Clip",
            category="MagiHuman_Rebel",
            inputs=[
...
class MagiHuman_Rebel_AUDIO_VAE(io.ComfyNode):
    @classmethod
    def define_schema(cls):
        return io.Schema(
            node_id="MagiHuman_Rebel_AUDIO_VAE",
            display_name="MagiHuman_Rebel_AUDIO_VAE",
            category="MagiHuman_Rebel",
            inputs=[
...
class MagiHuman_Rebel_EN_DECO_VIDEO(io.ComfyNode):
    @classmethod
    def define_schema(cls):
        return io.Schema(
            node_id="MagiHuman_Rebel_EN_DECO_VIDEO",
            display_name="MagiHuman_Rebel_EN_DECO_VIDEO",
            category="MagiHuman_Rebel",
            inputs=[
                io.Vae.Input("vae"),
...
class MagiHuman_Rebel_DECO_AUDIO(io.ComfyNode):
    @classmethod
    def define_schema(cls):
        return io.Schema(
            node_id="MagiHuman_Rebel_DECO_AUDIO",
            display_name="MagiHuman_Rebel_DECO_AUDIO",
            category="MagiHuman_Rebel",
            inputs=[
...
class MagiHuman_Rebel_LATENTS(io.ComfyNode):
    @classmethod
    def define_schema(cls):
        return io.Schema(
            node_id="MagiHuman_Rebel_LATENTS",
            display_name="MagiHuman_Rebel_LATENTS",
            category="MagiHuman_Rebel",
            inputs=[
...
class MagiHuman_Rebel_ENCODER(io.ComfyNode):
    @classmethod
    def define_schema(cls):
        return io.Schema(
            node_id="MagiHuman_Rebel_ENCODER",
            display_name="MagiHuman_Rebel_ENCODER",
            category="MagiHuman_Rebel",
            inputs=[
                io.Clip.Input("clip"),
    ...
    def execute(cls, clip, save_emb, prompt, negative_prompt) -> io.NodeOutput:
        ...
        # Free encoder from memory before DiT model loads
        del clip
        gc.collect()
...
class MagiHuman_Rebel_KSampler(io.ComfyNode):
    @classmethod
    def define_schema(cls):
        return io.Schema(
            node_id="MagiHuman_Rebel_KSampler",
            display_name="MagiHuman_Rebel_KSampler",
            category="MagiHuman_Rebel",
            inputs=[
...
class MagiHuman_Rebel_SRSampler(io.ComfyNode):
    @classmethod
    def define_schema(cls):
        return io.Schema(
            node_id="MagiHuman_Rebel_SRSampler",
            display_name="MagiHuman_Rebel_SRSampler",
            category="MagiHuman_Rebel",
            inputs=[
                io.Model.Input("model"),
                io.Latent.Input("latents"),
...
class MagiHuman_Rebel_Extension(ComfyExtension):
    @override
    async def get_node_list(self) -> list[type[io.ComfyNode]]:
        return [
            MagiHuman_Rebel_Model,
            MagiHuman_Rebel_VAE,
            MagiHuman_Rebel_Clip,
            MagiHuman_Rebel_AUDIO_VAE,
            MagiHuman_Rebel_EN_DECO_VIDEO,
            MagiHuman_Rebel_DECO_AUDIO,
            MagiHuman_Rebel_LATENTS,
            MagiHuman_Rebel_ENCODER,
            MagiHuman_Rebel_KSampler,
            MagiHuman_UnloadDiT,
            MagiHuman_Rebel_SRSampler,
        ]




async def comfy_entrypoint() -> MagiHuman_Rebel_Extension:
    return MagiHuman_Rebel_Extension()
